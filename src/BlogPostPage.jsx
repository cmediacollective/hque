  ...
  return (
    <div style={{ background: '#111', minHeight: '100vh', fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", color: '#F0ECE6' }}>
      ...
      <div style={{ height: isMobile ? '260px' : '480px', position: 'relative', overflow: 'hidden', marginTop: '80px' }}>
        <div style={{ position: 'absolute', inset: 0, backgroundImage: 'url(' + post.image + ')', backgroundSize: 'cover', backgroundPosition: post.imagePosition || 'center' }} />
      ...
      {related.length > 0 && (
        <div style={{ borderTop: '0.5px solid #1A1A1A', padding: isMobile ? '40px 24px 60px' : '60px 48px 80px', maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ fontSize: '9px', letterSpacing: '0.28em', textTransform: 'uppercase', color: '#5b7c99', marginBottom: '24px' }}><a href='/blog' style={{ color: '#5b7c99', textDecoration: 'none' }}>The Pitch</a> — More Articles</div>
