...
export const FAQS = [
  ...
  { q: 'Do you offer discounts?', a: 'New customers get 50% off their first month with the code WELCOME50 — enter it at checkout under "Add promotion code". It works on any plan, on top of the 14-day free trial. Beyond that, the Starter plan at $49/month is built for smaller teams and solo operators.' },
