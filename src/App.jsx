        ...
        <main style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: isMobile ? 'auto' : 'hidden', background: bg, minWidth: 0 }}>
          <div style={{ padding: isMobile ? '12px 16px' : '20px 28px 16px', borderBottom: `0.5px solid ${border}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div>
              ...
              {view === 'contacts' && <div style={{ fontSize: isMobile ? '11px' : '12px', color: subtle, marginTop: '3px', maxWidth: '64ch', lineHeight: 1.5 }}>Everyone your agency works with, in one place — clients, prospects, press and vendors, plus your talent, their managers and companies, pulled in automatically.</div>}
            </div>
