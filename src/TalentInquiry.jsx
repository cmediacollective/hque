...
export default function TalentInquiry() {
  ...
  if (!org) return (
    <div style={{ background: '#F8F7F3', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Inter Tight', 'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
  ...
  return (
    <div style={{ background: '#F8F7F3', minHeight: '100vh', fontFamily: "'Inter Tight', 'Helvetica Neue', Helvetica, Arial, sans-serif", color: '#1A1A1A' }}>
