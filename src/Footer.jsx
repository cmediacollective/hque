...
export default function Footer() {
  ...
  function subscribe() {
    ...
    fetch('/.netlify/functions/subscribe-klaviyo', {
      ...
      body: JSON.stringify({ email: e, firstName: 'Footer Subscriber', stage: 'leads', source: 'footer' }),
    }).catch(() => {})
  }
      ...
      <div style={{ display: 'grid', gridTemplateColumns: mobile ? '1fr 1fr' : '2fr 1fr 1fr 1fr', gap: mobile ? '32px' : '48px', marginBottom: '48px' }}>
        <div>
          ...
          <div style={{ display: 'flex', gap: '12px', marginTop: '16px' }}>
            ...
            <a href="https://www.facebook.com/hqueapp/" target="_blank" rel="noreferrer" style={{ color: '#BBB' }}>
