...
**HQue Metrics: date-range control + traffic location.** Renamed the tab to **HQue Metrics**. The Google Analytics section now has a **date-range switcher** — Last 7 days, Last 30 days, Last 90 days, This month, Last month — and shows **where visitors are located** (top countries and top cities) alongside traffic sources, all for the selected range.
